...
import { loadPhaseGate } from '@/lib/factory/load-target'
import { parseBrief, type PhaseGateBrief } from '@/lib/factory/phase-gate-brief-parser'
import { retrieveChunks, chunksToSources, type RagChunk } from '@/lib/factory/rag'
import {
  listSegmentsTool,
  getSegmentTool,
} from '@/lib/factory/mcp/segments-server'
import type { Segment, SegmentId } from '@/lib/factory/types'
